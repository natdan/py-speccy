...
class TestDecodeJPJRCALL:
    ...
    def test_call(self) -> None:
        assert_decode("call 0x1234", 0xcd, 0x34, 0x12)
        assert_decode("call nz, 0x1110", 0xc4 + 0 * 8, 0x10, 0x11)
        assert_decode("call z, 0x2211",  0xc4 + 1 * 8, 0x11, 0x22)
        assert_decode("call nc, 0x3312", 0xc4 + 2 * 8, 0x12, 0x33)
        assert_decode("call c, 0x4413",  0xc4 + 3 * 8, 0x13, 0x44)
        assert_decode("call po, 0x5514", 0xc4 + 4 * 8, 0x14, 0x55)
        assert_decode("call pe, 0x6615", 0xc4 + 5 * 8, 0x15, 0x66)
        assert_decode("call p, 0x7716",  0xc4 + 6 * 8, 0x16, 0x77)
        assert_decode("call m, 0x8817",  0xc4 + 7 * 8, 0x17, 0x88)
